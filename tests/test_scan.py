...
from reconPoint.tasks import (dir_file_fuzz, fetch_url, http_crawl,
                              initiate_scan, osint, port_scan,
...
class TestOnlineScan(unittest.TestCase):
    def setUp(self):
        ...
        self.endpoint, _ = EndPoint.objects.get_or_create(
            scan_history=self.scan, target_domain=self.domain, http_url=self.url
        )
