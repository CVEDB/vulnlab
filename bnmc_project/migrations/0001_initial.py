    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=255, verbose_name="Division Name"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=120,
                        null=True,
                        verbose_name="University/Board",
                    ),
                ),
                (
                    "roll",
                    models.CharField(
                        blank=True, max_length=120, null=True, verbose_name="Roll"
                    ),
                ),
                (
                    "cgpa",
                    models.CharField(
                        blank=True, max_length=120, null=True, verbose_name="CGPA"
                    ),
                ),
                (
                    "year",
                    models.IntegerField(blank=True, null=True, verbose_name="Ýear"),
                ),
                (
                    "duration",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "exam_name",
                    models.CharField(max_length=120, verbose_name="Exam Name"),
                ),
                (
                    "exam_code",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Exam Code"
                    ),
                ),
                (
                    "pass_mark",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Pass Mark"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "institution_name",
                    models.CharField(max_length=200, verbose_name="Center Name"),
                ),
                (
                    "institution_code",
                    models.CharField(max_length=100, verbose_name="Center Code"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        max_length=120, verbose_name="Institution Catagory Name"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "institute_type",
                    models.CharField(max_length=120, verbose_name="Institution Type"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "institution_code",
                    models.CharField(max_length=100, verbose_name="Institution Code"),
                ),
                ("village", models.CharField(max_length=200)),
                ("post_office", models.CharField(blank=True, max_length=100)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="bnmc_project.InstituteCatagory",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="bnmc_project.Division",
                    ),
                ),
                (
                    "exam_ins",
                    models.ManyToManyField(
                        blank=True, to="bnmc_project.Exam", verbose_name="Exam"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(max_length=300, verbose_name="Full name (Bangla)"),
                ),
                (
                    "last_name",
                    models.CharField(
                        max_length=300, verbose_name="Full name (English)"
                    ),
                ),
                ...
                (
                    "license_start_date",
                    models.DateField(blank=True, max_length=120, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, upload_to="media/", verbose_name="Upload photo"
                    ),
                ),
                (
                    "image_sec",
                ...
                (
                    "signature_sec",
                    models.ImageField(
                        blank=True, upload_to="media/", verbose_name="up photo"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "program_fee",
                    models.CharField(
                        blank=True, max_length=10, null=True, verbose_name="Program Fee"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=120, verbose_name="Program Catagory Name"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration",
                    models.DecimalField(
                        decimal_places=9, max_digits=10, verbose_name="Program Duration"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=100, verbose_name="Minimum Qualification"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration_no",
                    models.CharField(blank=True, default=0, max_length=120, null=True),
                ),
                ...
                (
                    "village_snd",
                    models.CharField(max_length=300, verbose_name="Village"),
                ),
                (
                    "post_office_snd",
                    models.CharField(max_length=300, verbose_name="Post office"),
                ),
                (
                    "postal_code_snd",
                    models.CharField(
                        blank=True, max_length=300, verbose_name="Postal code"
                    ),
                ),
                (
                    "district",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="bnmc_project.Relation_to_guardians",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_method",
                    models.CharField(
                        choices=[("1", "Bank Draft"), ("2", "Cash"), ("3", "Cheque")],
                        max_length=120,
                    ),
                ),
                ...
                (
                    "migration",
                    models.BooleanField(default=False, verbose_name="migrateable"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=120, verbose_name="Police Station Name"
                    ),
                ),
                (
                    "district",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="bnmc_project.ProgramCatagory",
                verbose_name="Program Catagory ",
            ),
        ),
        migrations.AddField(
            model_name="program",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="bnmc_project.ProgramDuration",
                verbose_name="Program Duration",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to="bnmc_project.Program", verbose_name="Program"
            ),
        ),
        migrations.AddField(
            model_name="institution",
        ...
        migrations.AddField(
            ...
            name="division",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="bnmc_project.Division"
            ),
        ),
        migrations.AddField(
            model_name="examcenter",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="bnmc_project.Student_Registration",
            ),
        ),
        migrations.AddField(
            model_name="educationqualification",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="show_permission_permissions",
                to="bnmc_project.Permission",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="head_of", to="bnmc_project.Institution"
            ),
        ),
        migrations.AddField(
            model_name="user",
            name="staff_status",
            field=models.ManyToManyField(
                related_name="staff_status_permissions", to="bnmc_project.Permission"
            ),
        ),
        migrations.AddField(
            model_name="user",
