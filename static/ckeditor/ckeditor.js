          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var l = 0, f = c.length, t; l < f; ++l)
                  (t = c[l]), e[t] || (e[t] = a(t));
                a = !1;
              }
            else a = !1;
            ...
            for (
              ...
              (f = d[--t]),
                ...
                (f.type == CKEDITOR.NODE_TEXT ||
                  (f.type == CKEDITOR.NODE_ELEMENT && z.$inline[f.name]))
                  ? (v ||
...
*/
  ...
  CKEDITOR.config.plugins =
    "dialogui,dialog,about,basicstyles,button,toolbar,notification,clipboard,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo";
