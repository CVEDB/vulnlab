...
urlpatterns = [
    ...
    path("<slug:slug>/add/target", views.add_target, name="add_target"),
    path(
        "<slug:slug>/add/organization", views.add_organization, name="add_organization"
    ),
    path(
        "<slug:slug>/update/target/<int:id>", views.update_target, name="update_target"
    ),
    path(
    ...
    path("<slug:slug>/list/target", views.list_target, name="list_target"),
    path(
